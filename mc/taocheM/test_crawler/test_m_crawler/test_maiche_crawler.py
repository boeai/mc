...
maiche_url = config.maiche_url

class M_maiche_crawler(Base):

    def test_M_maiche(self):
        """遍历M卖车页链接并验证状态码,@author:xulanzhong"""
        self.driver.get(maiche_url)
