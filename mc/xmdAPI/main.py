...
# 生成报告
runner = AutoTest(suite=discover, name='小马达API测试', to_user=to_user, case_type='API', env=env)
runner.run()


# 调试单个用例
# from xmdAPI.test_yd_api.test_login_case import TestLoginCase
#
# suite = unittest.TestSuite()
# suite.addTest(TestLoginCase('test_get_token'))
